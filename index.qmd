...
SMORES was built in R Shiny for NOAA NMFS teams to be able to use as a fast and interactive tester for scenarios provided to BOEM during the energy use area siting process off the West Coast of the United States. The most recent example of this was when the West Coast NOAA offices were working together on the Oregon wind energy areas.
...
The Application is available on the Posit Connect Test Instance. For more information about accessing the SMORES app please visit the SMORES [Access](https://noaa-nwfsc.github.io/SMORES/Access.html) page. 
