...
The normalized AOI-cropped map shows the AOI-filtered data rescaled to a 0-1 range using a min max normalization for only the values within the selected area, making it easier to compare relative differences within the AOI. The data in this visualization is purely for highlighting the visual differences between cell scores. The values given are not used in any downstream calculations. 
