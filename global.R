...
# Check if the app is currently running on the Posit Connect server
...
# Enable server-side bookmarking for the app
enableBookmarking(store = "server")

# Initialize the storage class and pass it our Connect board
app_storage <- StorageClass$new(board_sessions = app_board)
