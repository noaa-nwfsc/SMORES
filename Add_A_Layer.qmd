...
The SMORES application is modular. Adding a new data layer to an existing component (e.g., adding a new species to the "Species" tab) using standard scoring methodology requires modifying five specific files in a specific order.

## Step 1: Data Preparation

Before touching the Shiny application code, ensure your spatial data is processed and staged.

Run the appropriate pre-processing scripts (e.g., data_processing/) to generate the formatted .parquet files for the new layer. You will need to process the data for both the 2km and 5km grid cell size. 

Verify that the files follow the standard naming convention (e.g., New_Layer_scored_full.parquet).
...
## Step  5: Update the Data Tab Ledger 
...
Append your new layer's information to the end of the four main setup vectors:
...
## Step 6: Front-End Documentation Updates
...
To update this file run the following code in the console: `rsconnect::writeManifest(appDir = ...)`
