generate_submodel_combined_report <- function(
  ...
  # Show spinner modal
  show_spinner_modal(
    "Generating Combined Submodel Report",
    paste(
      "Please wait while the",
      submodel_type,
      "Combined Submodel report is being generated..."
    )
  )
  ...
  if (submodel_type == "natural_resources") {
    ...
    stop(
      "Invalid submodel_type. Use 'natural_resources', 'fisheries', or 'industry_operations'"
    )
  }
