...
The SMORES app uses a variety of custom functions to create a model run. Some of these functions are for the structure of the Shiny App while others focus on the methods to combine layers, calculate combined scores, or generate maps. The purpose of this page is to provide an overview of the different functions should you have questions regarding the underlying processes used to create a visualization or a model run. If you would like to access the functions and see the underlying code please visit the [R folder](https://github.com/noaa-nwfsc/SMORES/tree/main/R){target="_blank"} in the data [repository](https://github.com/noaa-nwfsc/SMORES){target="_blank"} on the Github enterprise. 

## Functions used for Mapping and Aesthetics:

#### [filter_by_score()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/filter_by_score.R){target="_blank"}
...
#### [apply_calculation_method()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/apply_calculation_method.R){target="_blank"}

Function to create data for a combined submodel map using the user-selected method (geometric mean, lowest, or product). 

#### [calculate_geometric_mean_combined()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/calculate_geometric_mean_combined.R){target="_blank"}

Function that when applied calculates the geometric mean for an applied set of layers for each 2 km cell.

#### [calculate_lowest_combined()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/calculate_lowest_combined.R){target="_blank"}

Function that when applied calculates the lowest score for an applied set of layers for each 2km cell.

#### [calculate_product_combined()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/calculate_product_combined.R){target="_blank"}

Function that when applied calculates the product score for an applied set of layers for each 2km cell.

#### [create_individual_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_individual_map.R){target="_blank"}
...
#### [create_combined_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_combined_map.R){target="_blank"}
...
#### [calculate_submodel_geometric_mean()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/calculate_submodel_geometric_mean.R){target="_blank"}
...
#### [check_submodel_status()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/check_submodel_status.R){target="_blank"}

Function to indicate which submodels are ready to be included in the full model run. 

#### [create_combined_submodel_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_combined_submodel_map.R){target="_blank"}
...
#### [create_aoi_cropped_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_aoi_cropped_map.R){target="_blank"}
...
#### [create_aoi_cropped_normalized_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_aoi_cropped_normalized_map.R){target="_blank"}
...
#### [create_full_model_map()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/create_full_model_map.R){target="_blank"}
...
#### [crop_data_to_aoi()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/crop_data_to_aoi.R){target="_blank"}
...
#### [data_timestamps()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/data_timestamps.R){target="_blank"}
...
#### [filtered_data_timestamps()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/filtered_data_timestamps.R){target="_blank"}

Function to filter which datasets are in use within the app for the SMORES reports. 

## Functions used for generating reports:

#### [generate_submodel_component_report()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/generate_submodel_component_report.R){target="_blank"}
...
#### [generate_submodel_combined_report()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/generate_submodel_combined_report.R){target="_blank"}
...
#### [generate_full_model_report()](https://github.com/noaa-nwfsc/SMORES/blob/main/R/generate_full_model_report.R){target="_blank"}
